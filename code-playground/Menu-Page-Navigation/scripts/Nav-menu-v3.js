// ==UserScript==
// @name         Navigation Menu V2
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Creates a custom navigation menu with specific functionality
// @match        *://*/*
// @grant        none
// ==/UserScript==
...
#rsm-nav-menu {
  ...
  gap: calc(var(--rsNavMenuPosition) * .5)
