...
*************/
:root {
		--toolBarBgContainer: tr;
		--toolBarBrdClr: hsl(220, 10%, 87%);
		--toolBarBgBar: hsl(220, 60%, 91%);
		--toolbarButtonBg-Hover: hsl(210, 0%, 50%,.3);
		--toolBarButtonBg-Active: hsl(200, 40%, 50%,.5);
		--toolBarButtonSpecialBg:hsl(200, 40%, 50%,.5);
}
...
.docs-grille-gm3 #docs-omnibox-toolbar .docs-omnibox-input {
		background: var(--toolBarBgContainer) !important;
}
...
.docs-grille-gm3.docs-gm .trix-palette .goog-palette-cell-selected {
		background: var(--toolBarButtonBg-Active) !important;
}
...
.docs-grille-gm3 #docs-header:not(.docs-hub-appbar) .docs-titlebar-buttons {
		background: var(--toolBarBgContainer);
}
...
.docs-grille-gm3 .docs-menubar .goog-control-open {
		background: var(--toolbarButtonBg-Hover);
}
/*toolbar container - Button - Active*/
/*****
 COLLAPSED / OPEN
******/
.docs-butterbar-container.docs-butterbar-container-compact ~ #docs-bars:before {
		content: "";
		display: block;
		position: absolute;
		bottom: -8px;
