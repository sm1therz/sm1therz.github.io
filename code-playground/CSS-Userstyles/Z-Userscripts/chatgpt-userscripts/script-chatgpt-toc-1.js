	...
	`;
		...
		function buildTOC() {
				...
				for (let i = 0; i < articles.length; i++) {
						...
						const isAI = art.querySelector("[data-message-author-role='assistant']") !== null;
						const isUser = art.querySelector("[data-message-author-role='user']") !== null;
						...
						for (let h = 0; h < heads.length; h++) {
								...
								const txt = (hd.textContent || "").trim();
								if (txt === "ChatGPT said:") continue;
								subLi.textContent = txt || ("Section " + (h + 1));
