...
// @version      2.8
// @description  Persistent toggle panel (localStorage-backed). Hashtags: convert # to H2 (with tag list + promote-to-top-level), remove hashtags, capitalize, dashes-to-spaces. Cleanup: remove links, remove == highlights. Notes: clean note blockquotes. Always-on: list-indentation normalization to tabs. Works with current Workflowy export DOM.
